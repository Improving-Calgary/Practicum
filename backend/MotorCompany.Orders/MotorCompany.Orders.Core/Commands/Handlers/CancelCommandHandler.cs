...
{
    public class CancelCommandHandler : IRequestHandler<CancelCommand, IResult>
    {
        ...
        public async Task<IResult> Handle(CancelCommand request, CancellationToken cancellationToken)
        {
