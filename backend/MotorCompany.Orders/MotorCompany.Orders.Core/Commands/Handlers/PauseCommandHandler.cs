...
{
    public class PauseCommandHandler : IRequestHandler<PauseCommand, IResult>
    {
        private readonly IUnitOfWork _unitOfWork;

        public PauseCommandHandler(IUnitOfWork unitOfWork)
        {
            _unitOfWork = unitOfWork;
        }

        public async Task<IResult> Handle(PauseCommand request, CancellationToken cancellationToken)
        {
